...
export default class App extends React.Component {
    ...
    carColorChange() {
        ...
        if (color == 2) {
            this.state.color = require('./img/ennemy1.png');
        } else {
            this.state.color = require('./img/ennemy2.png');
        }
    }
    ...
    render() {
        return (
            <ImageBackground source={require('./img/back.png')} style={styles.container}>
                <View style={{ flex: 1, marginTop: Dimensions.get('window').height - (Dimensions.get('window').height - 20) }}>
                ...
                <Animated.Image
                    ...
                    style={[styles.player, { paddingBottom: 20, transform: [{ translateX: this.state.movePlayerVal }] }]}
                />
                <Enemy
                ...
                <View style={styles.controls}>
                    <TouchableOpacity onPress={() => this.movePlayer('left')}>
                        <Image source={require('./img/gauche.png')} style={styles.left} />
                    </TouchableOpacity>
                    <View style={{ width: 30 }} />
                    <TouchableOpacity onPress={() => this.movePlayer('right')}>
                        <Image source={require('./img/droite.png')} style={styles.right} />
                    </TouchableOpacity>
                </View>
            </ImageBackground>
        );
